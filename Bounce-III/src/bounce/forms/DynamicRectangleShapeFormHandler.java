...
public class DynamicRectangleShapeFormHandler implements FormHandler {
	...
	public DynamicRectangleShapeFormHandler(ShapeModel model, NestingShape parent) {
		_model = model;
	...
	public void processForm(Form form) {
		...
		Color colour = (Color) form.getFieldValue(Color.class, ColourFormElement.COLOUR);
